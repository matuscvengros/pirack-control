...
<div class="flex flex-col h-full px-6">
	<div class="text-[9px] text-[#4a5580] uppercase tracking-[2px] text-center pt-[70px] mb-8">Cooling</div>
	<div class="flex flex-col items-center">
		<div class="text-[28px] mb-1">❄️</div>
		<div
			class="inline-block px-3 py-0.5 rounded-full text-[13px] font-semibold border"
